...
def main():
    design = [
        ...
        (11, 2), (12, 2), (13, 2), (14, 2), (15, 2), (11, 2), (12, 3), (13, 3), (14, 3), (18, 3), (7, 4), (16, 4),
        (19, 4), (6, 5), (17, 5), (20, 5), (5, 6), (21, 6), (4, 7), (22, 7), (3, 8), (8, 8), (23, 8), (8, 9), (12, 9),
        (13, 9), (14, 9), (2, 10), (10, 10), (11, 10), (15, 10), (16, 10), (24, 10), (2, 11), (10, 11), (16, 11),
        (20, 11), (21, 11), (24, 11), (2, 12), (3, 12), (24, 12), (2, 13), (3, 13), (24, 13), (2, 14), (3, 14), (5, 14),
        (23, 14), (24, 14), (2, 15), (3, 15), (4, 15), (6, 15), (18, 15), (23, 15), (24, 15), (3, 16), (4, 16),
        (18, 16), (23, 16), (3, 17), (4, 17), (23, 17), (3, 18), (4, 18), (13, 18), (22, 18), (23, 18), (4, 19),
        (5, 19), (13, 19), (21, 19), (22, 19), (5, 20), (6, 20), (19, 20), (20, 20), (21, 20), (6, 21), (7, 21),
        (11, 21), (12, 21), (13, 21), (18, 21), (19, 21), (20, 21), (7, 22), (8, 22), (9, 22), (10, 22), (11, 22),
        (12, 22), (13, 22), (14, 22), (15, 22), (16, 22), (17, 22), (18, 22), (19, 22), (8, 23), (9, 23), (10, 23),
        (11, 23), (12, 23), (13, 23), (14, 23), (15, 23), (16, 23), (17, 23), (18, 23), (11, 24), (12, 24), (13, 24),
        (14, 24), (15, 24)
    ]
    ...
    for step in optimal_path_test:
        print(f"Step {step[0]:4d}: Stitch from ({step[1][0]:3d}, {step[1][1]:3d}) to ({step[2][0]:3d}, {step[2][1]:3d}), Transition Distance: {step[3]:.2f}")
